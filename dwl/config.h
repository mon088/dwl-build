...
static uint32_t colors[][3]                = {
	/*               fg          bg          border    */
        [SchemeNorm] = { 0xC6A0F6ff, 0x000000ff, 0x1A1A1Aff }, // soft lavender text on pure black, dark gray border
        [SchemeSel]  = { 0xFFFFFFFF, 0x6E56CFff, 0x6E56CFff }, // white text, bold royal purple background/border
        [SchemeUrg]  = { 0xFFFFFFFF, 0x000000ff, 0xB4637Aff }, // white text, black bg, pinkish-purple border
...
static const Rule rules[] = {
	...
	{ "brave",  NULL,       1 << 1,       0,           -1 }, /* Start on ONLY tag "9" */
	{ "vesktop",  NULL,       1 << 2,       0,	0,	0,	   -1 }, /* Start on ONLY tag "9" */
	{ "steam",  NULL,       1 << 3,       0,	0,	0,	   -1 }, /* Start on ONLY tag "9" */
	{ "foot",             NULL,       0,            0,           1,       0,          -1 },
};
...
static const double accel_speed = -0.44;
...
static const Key keys[] = {
	...
	{ MODKEY,                    XKB_KEY_y,          setlayout,      {.v = &layouts[4]} },
	{ MODKEY,                    XKB_KEY_w,          setlayout,      {.v = &layouts[5]} },	
	...
	{ 0,              XKB_KEY_Print,   spawn,       SHCMD(" /home/mon/screenshot ") },
	...
	{ MODKEY,              XKB_KEY_v,   spawn,       SHCMD(" vesktop ") },
